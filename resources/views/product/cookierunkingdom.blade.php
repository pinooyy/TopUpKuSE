...
<head>
    ...
    <title>TopUpKu | Cookierun Kingdom</title>
...
<body>
    ...
    <section class="banner-container">
        <img class="banner-blur" src="../Assets SoftEng/cookierunkingdom_banner.avif" alt="Background Blur" />
        <div class="banner">
            <img src="../Assets SoftEng/cookierunkingdom_banner.avif" alt="Banner Cookierun Kingdom" />
        </div>
    </section>

    <div class="container">
        <div class="product-info">
            <h1>COOKIERUN KINGDOM (VIA UID)</h1>
            <p>TopUpKu menyediakan topup Cookierun Kingdom 100% legal via UID langsung untuk akun yang register via Android, iOS, PC, dan PS.</p>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            function setupActiveState(groupSelector) {
                ...
                if (!group) return;
                const buttons = group.querySelectorAll('button, input[type="radio"]');
