...
<head>
    ...
    <title>TopUpKu | Cookie Run Kingdom</title>
...
<body>
    ...
    <section class="banner-container">
        ...
        <div class="banner">
            <img src="../Assets SoftEng/cookierunkingdom_banner.avif" alt="Banner Cookie Run Kingdom">
        </div>
    </section>
    ...
    <div class="container">
        <div class="product-info">
            ...
            <p>TopUpKu menyediakan top up Diamond dan paket lainnya untuk Cookie Run Kingdom dengan harga terjangkau dan proses cepat.</p>
        ...
        <form method="POST" action="{{ route('checkout.show') }}" class="topup-form">
            ...
            <input type="text" name="data" placeholder="Masukkan ID Anda" required>
