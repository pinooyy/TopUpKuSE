...
<body>
    ...
    <section class="banner-container">
        <img class="banner-blur" src="../Assets SoftEng/roblox_banner.jpg" alt="Background Blur">
        <div class="banner">
            <img src="../Assets SoftEng/roblox_banner.jpg" alt="Banner Roblox">
        </div>
    </section>
    ...
    <div class="container">
        <div class="product-info">
            <h1>ROBLOX (ROBUX)</h1>
            <p>TopUpKu menyediakan layanan isi ulang Robux resmi, cepat dan terpercaya untuk semua akun Roblox Anda.</p>
        ...
        <form method="POST" action="{{ route('checkout.show') }}" class="topup-form">
            @csrf
            <h2>1. MASUKKAN USERNAME AKUN ROBLOX</h2>
            <input type="text" name="data" placeholder="Masukkan Username Roblox Anda" required>

            <h2>2. PILIH NOMINAL ROBOX</h2>
