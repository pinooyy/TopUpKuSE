...
<head>
    ...
    <title>TopUpKu | SuperStar GFriend</title>
...
<body>
    ...
    <section class="banner-container">
        ...
        <div class="banner">
            <img src="../Assets SoftEng/superstargfriend_banner.webp" alt="Banner SuperStar GFriend" />
        </div>
    </section>

    <div class="container">
        <div class="product-info">
            <h1>SUPERSTAR GFRIEND (VIA UID)</h1>
            <p>TopUpKu menyediakan topup SuperStar GFriend 100% legal via UID langsung untuk akun yang register via Android, iOS, PC, dan PS.</p>
