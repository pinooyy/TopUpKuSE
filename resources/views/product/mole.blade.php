...
<head>
    ...
    <title>TopUpKu | Mobile Legends</title>
...
<body>
    ...
    <section class="banner-container">
        ...
        <div class="banner">
            <img src="../Assets SoftEng/mole_banner.webp" alt="Banner Mobile Legends" />
        </div>
    </section>

    <div class="container">
        <div class="product-info">
            <h1>MOBILE LEGENDS (VIA UID)</h1>
            <p>TopUpKu menyediakan topup Mobile Legends 100% legal via UID langsung untuk akun yang register via Android, iOS, PC, dan PS.</p>
