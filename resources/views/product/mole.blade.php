...
<head>
    ...
    <title>TopUpKu | Mole's World</title>
...
<body>
    ...
    <section class="banner-container">
        ...
        <div class="banner">
            <img src="../Assets SoftEng/mole_banner.webp" alt="Banner Mole's World">
        </div>
    </section>

    <div class="container">
        <div class="product-info">
            <h1>MOLE'S WORLD (VIA UID)</h1>
            <p>TopUpKu menyediakan top-up resmi untuk Mole’s World dengan cepat dan aman melalui UID akun Anda.</p>
