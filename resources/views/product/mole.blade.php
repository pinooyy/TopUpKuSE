...
<body>
    ...
    <section class="banner-container">
        <img class="banner-blur" src="../Assets SoftEng/mobile-legends-banner.jpg" alt="Background Blur">
        <div class="banner">
            <img src="../Assets SoftEng/mobile-legends-banner.jpg" alt="Banner Genshin Impact">
        </div>
    </section>
