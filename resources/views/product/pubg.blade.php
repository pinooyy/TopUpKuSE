...
<body>
    ...
    <section class="banner-container">
        <img class="banner-blur" src="../Assets SoftEng/pubg_banner.jpeg" alt="Background Blur" />
        <div class="banner">
            <img src="../Assets SoftEng/pubg_banner.jpeg" alt="Banner PUBG Mobile" />
        </div>
    </section>

    <div class="container">
        <div class="product-info">
            <h1>PUBG MOBILE (VIA UID)</h1>
            <p>TopUpKu menyediakan topup PUBG Mobile 100% legal via UID langsung untuk akun yang register via Android, iOS, PC, dan PS.</p>
