...
<head>
    ...
    <title>TopUpKu | PUBG Mobile</title>
...
<body>
    ...
    <section class="banner-container">
        <img class="banner-blur" src="../Assets SoftEng/pubgm_banner.jpeg" alt="Background Blur">
        <div class="banner">
            <img src="../Assets SoftEng/pubgm_banner.jpeg" alt="Banner PUBG Mobile">
        </div>
    </section>

    <div class="container">
        <div class="product-info">
            <h1>PUBG MOBILE (VIA PLAYER ID)</h1>
            <p>TopUpKu menyediakan UC PUBG Mobile resmi dengan proses cepat dan aman. Cukup masukkan Player ID Anda untuk melanjutkan.</p>
        ...
        <form method="POST" action="{{ route('checkout.show') }}" class="topup-form">
            ...
            <input type="text" name="data" placeholder="Masukkan Player ID Anda" required>
