...
<body>
    ...
    <section class="banner-container">
        <img class="banner-blur" src="../Assets SoftEng/epep_banner.jpg" alt="Background Blur" />
        <div class="banner">
            <img src="../Assets SoftEng/epep_banner.jpg" alt="Banner Free Fire" />
        </div>
    </section>

    <div class="container">
        <div class="product-info">
            <h1>FREE FIRE (VIA UID)</h1>
            <p>TopUpKu menyediakan topup Free Fire 100% legal via UID langsung untuk akun yang register via Android, iOS, PC, dan PS.</p>
