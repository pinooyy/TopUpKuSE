...
<body>
    ...
    <section class="banner-container">
        ...
        <div class="banner">
            <img src="../Assets SoftEng/steam_banner.jpg" alt="Banner Steam" />
        </div>
    </section>
    ...
    <div class="container">
        <div class="product-info">
            <h1>STEAM (VIA UID)</h1>
            <p>TopUpKu menyediakan topup Steam 100% legal via UID langsung untuk akun yang register via Android, iOS, PC, dan PS.</p>
