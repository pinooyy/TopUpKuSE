...
<head>
    ...
    <title>TopUpKu | Steam Wallet</title>
...
<body>
    ...
    <section class="banner-container">
        ...
        <div class="banner">
            <img src="../Assets SoftEng/steam_banner.jpg" alt="Banner Steam Wallet">
        </div>
    </section>

    <div class="container">
        <div class="product-info">
            <h1>STEAM WALLET CODE</h1>
            <p>TopUpKu menyediakan voucher Steam Wallet resmi untuk mengisi saldo akun Steam Anda dengan mudah dan cepat.</p>
        ...
        <form method="POST" action="{{ route('checkout.show') }}" class="topup-form">
            @csrf
            <h2>1. MASUKKAN EMAIL / USERNAME AKUN STEAM</h2>
            <input type="text" name="data" placeholder="Masukkan Email atau Username Steam Anda" required>

            <h2>2. PILIH NOMINAL VOUCHER</h2>
