...
<body>
    ...
    <section class="banner-container">
        <img class="banner-blur" src="../Assets SoftEng/valorant_banner.jpg" alt="Background Blur">
        <div class="banner">
            <img src="../Assets SoftEng/valorant_banner.jpg" alt="Banner Valorant">
        </div>
    </section>

    <div class="container">
        <div class="product-info">
            <h1>VALORANT (VIA RIOT ID)</h1>
            <p>TopUpKu menyediakan top-up Valorant Point (VP) resmi dan cepat langsung ke akun Anda via Riot ID.</p>
        ...
        <form method="POST" action="{{ route('checkout.show') }}" class="topup-form">
            @csrf
            <h2>1. MASUKKAN RIOT ID</h2>
            <input type="text" name="data" placeholder="Contoh: Username#1234" required>
